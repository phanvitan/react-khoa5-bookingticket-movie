...
function SampleNextArrow(props) {
  ...
  return (
    <div className={`${className} ${styleSlick['slick-prev']}`} style={{ ...style, display: "block", color: 'black' }} onClick={onClick}>
...
const MultipleRowSlick = (props) => {
  ...
  return (
    <div>
      <button className={`${styleSlick[activeClassDC]} px-8 py-3 font-semibold rounded bg-gray-800 text-white border mr-2`} onClick={() => {
