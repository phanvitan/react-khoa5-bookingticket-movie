    ...
    return (
        <div className="flip-card mt-2">
            ...
            <div>
                ...
                {/* Cach 1 : dung navlink,  cach nay toi uu cho SEO google  */}
                {/* <div className="w-full bg-orange-300 text-center cursor-pointer py-2 bg-indigo-300 my-2 text-success-50 font-bold">
                    <NavLink to={`/detail/${item.maPhim}`} >Đặt vé</NavLink>
                </div> */}

                {/* cach 2 : dung onClick va 'history', cach nay khong toi uu cho SEO GOOGLE */}
