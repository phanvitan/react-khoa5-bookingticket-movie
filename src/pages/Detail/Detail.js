    ...
    return (
        <div style={{ backgroundImage: `url(${filmDetail.hinhAnh})`, backgroundSize: '100%', backgroundPosition: 'center', minHeight: '100vh' }} >
            ...
            >
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-4">
                        ...
                        <h1 style={{ marginLeft: '5%' }} className="text-green-400 text-2xl" >
                            <Rate allowHalf defaultValue={filmDetail.danhGia / 2} style={{ color: '#78ed78', fontSize: 30 }} />
                        </h1>
                ...
                <div className="mt-20 ml-72 w-2/3 bg-white px-5 py-5 container">
                                ...
                                <Tabs tabPosition={'left'}>
                                    {filmDetail.heThongRapChieu?.map((htr, index) => {
                                        return (
                                            <TabPane tab={
                                                <div>
                                                    <img src={htr.logo} alt={htr.logo} width={50} height={50} className="rounded-full" />
                                                    {htr.tenHeThongRap}
                                                </div>
                                            } key={index}>
                                                    ...
                                                    return (
                                                        <div className="mt-5" key={index}>
                                                            <div className="flex flex-row">
                                                                <img style={{ width: 60, height: 60 }} src={`https://s3img.vcdn.vn/123phim/2021/01/bhd-star-vincom-quang-trung-16105960645760.png`} alt="" />
                                                                <div className="ml-2">
