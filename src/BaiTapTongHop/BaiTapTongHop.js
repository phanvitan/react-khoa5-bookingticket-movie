            ...
            <div className="grid grid-cols-6">
                <div className="col-span-1 h-full p-3 space-y-2 bg-coolGray-50 text-coolGray-800">
                    <div className="flex items-center p-2 space-x-4">
                        <img src="https://source.unsplash.com/100x100/?portrait" alt className="w-12 h-12 rounded-full bg-coolGray-500" />
                        <div>
                    ...
                    <div className="divide-y divide-coolGray-300">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            {mangDanhMuc.map((danhMuc, index) => {
                                const classNameActive = ['flex', 'items-center', 'p-2', 'space-x-3', 'rounded-md', maDanhMuc === danhMuc.maDanhMuc ? 'bg-red-400 text-white' : ''];
                                return (
